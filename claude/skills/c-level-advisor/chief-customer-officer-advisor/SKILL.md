...
# 4. Cross-check with ds-cro-advisor: does the expansion math add up?
# 5. Cross-check with ds-cpo-advisor: are product gaps driving churn?
...
# 5. Cross-check with ds-cfo-advisor on the cost
...
4. Cross-check with ds-chro-advisor
