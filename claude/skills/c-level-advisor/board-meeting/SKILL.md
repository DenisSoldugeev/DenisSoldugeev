...
## Keywords
board meeting, executive deliberation, strategic decision, C-suite, multi-agent, /ds:board, founder review, decision extraction, independent perspectives

## Invoke
`/ds:board [topic]` — e.g. `/ds:board Should we expand to Spain in Q3?`
...
- Reopen any time with `/ds:board resume`
