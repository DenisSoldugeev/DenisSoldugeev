...
## Keywords
board meeting, executive deliberation, strategic decision, C-suite, multi-agent, /ds:boardroom, founder review, decision extraction, independent perspectives

## Invoke
`/ds:boardroom [topic]` — e.g. `/ds:boardroom Should we expand to Spain in Q3?`
...
- Reopen any time with `/ds:boardroom resume`
