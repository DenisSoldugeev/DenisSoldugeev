...
- Cross-check with ds-cmo-advisor.
...
- `/ds:cfo-review` — does this hit the cash plan?
- `/ds:cmo-review` — is pipeline source-mix healthy?
- `/ds:execute` — quarterly plan if GREEN
- `/ds:boardroom` — if RED

## Related

- Agent: [`ds-cro-advisor`](../../agents/ds-cro-advisor.md)
- Skill: [`cro-advisor`](../../../cro-advisor/SKILL.md)
