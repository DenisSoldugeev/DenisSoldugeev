...
- `/ds:ciso-review` — for any data-touching contract
- `/ds:cfo-review` — for any commitment > 1 year or > 1% of revenue
- `/ds:decide` — log the verdict after outside counsel review
