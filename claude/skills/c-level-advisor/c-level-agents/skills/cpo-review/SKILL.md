...
- `/ds:cmo-review` — does the positioning support this feature?
- `/ds:execute` — build the 90-day plan
- `/ds:post-mortem` — if kill criteria triggered
