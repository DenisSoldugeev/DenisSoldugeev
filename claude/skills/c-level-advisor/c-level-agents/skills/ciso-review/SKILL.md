...
- `/ds:cto-review` — architecture alignment
- `/ds:gc-review` — DPA, regulatory implications
- `/ds:decide` — log risk acceptance
- `/ds:boardroom` — for CRITICAL risks

## Related

- Agent: [`ds-ciso-advisor`](../../agents/ds-ciso-advisor.md)
- Skill: [`ciso-advisor`](../../../ciso-advisor/SKILL.md)
