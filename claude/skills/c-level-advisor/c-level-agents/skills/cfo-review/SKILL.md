...
- `/ds:execute` — build 90-day plan if GREEN
- `/ds:boardroom` — escalate if multi-role implications

## Related

- Agent: [`ds-cfo-advisor`](../../agents/ds-cfo-advisor.md)
- Skill: [`cfo-advisor`](../../../cfo-advisor/SKILL.md)
