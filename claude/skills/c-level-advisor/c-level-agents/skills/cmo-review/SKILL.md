...
- `/ds:cro-review` — pipeline contribution check
- `/ds:cpo-review` — product ↔ positioning alignment
- `/ds:decide` — log the verdict

## Related

- Agent: [`ds-cmo-advisor`](../../agents/ds-cmo-advisor.md)
- Skill: [`cmo-advisor`](../../../cmo-advisor/SKILL.md)
