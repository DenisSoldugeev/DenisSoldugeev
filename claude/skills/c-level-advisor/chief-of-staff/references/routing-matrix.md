...
| Skill | Trigger | File |
|-------|---------|------|
| C-Suite Onboard | `/ds:setup`, first-time setup, "tell me about your company" | ds-onboard |
| Context Engine | Auto-loaded; staleness check | context-engine |
| Board Meeting | `/ds:boardroom`, multi-role decisions, score ≥ 4 | board-meeting |
| Decision Logger | After board meetings, `/ds:decisions`, `/ds:review` | decision-logger |
