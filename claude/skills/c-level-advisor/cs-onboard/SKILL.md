---
name: "ds-onboard"
description: "Founder onboarding interview that captures company context across 7 dimensions. Invoke with /ds:setup for initial interview or /ds:update for quarterly refresh. Generates ~/.claude/company-context.md used by all C-suite advisor skills."
license: MIT
metadata:
  version: 1.0.0
  category: c-level
...
- `/ds:setup` — Full onboarding interview (~45 min, 7 dimensions)
- `/ds:update` — Quarterly refresh (~15 min, "what changed?")

## Keywords
ds:setup, ds:update, company context, founder interview, onboarding, company profile, c-suite setup, advisor setup
...
Tell the founder: *"I've captured everything in your company context. Every advisor will use this to give specific, relevant advice. Run /ds:update in 90 days to keep it current."*

---

## /ds:update — Quarterly Refresh
