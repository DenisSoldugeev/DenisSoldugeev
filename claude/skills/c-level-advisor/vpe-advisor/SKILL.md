...
This skill is **NOT a ds-engineering-lead replacement**. Engineering-lead owns day-to-day incident and on-call coordination. VPE owns the operating model that engineering-lead executes.
...
# 4. Cross-check with ds-cto-advisor on architectural causes
...
# 4. Cross-check with ds-chro-advisor on comp/leveling competitiveness
# 5. Cross-check with ds-cfo-advisor on cost-per-hire envelope
...
# 4. Cross-check with ds-cto-advisor on Conway's Law alignment
...
- `ds-engineering-lead` agent — Day-to-day incident + on-call coordination (VPE owns the operating model that engineering-lead executes)
