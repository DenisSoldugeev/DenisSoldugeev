...
def render_text(result: Dict[str, Any], source: str) -> str:
    ...
    lines.append("you design will shape the systems you build. Pair this with ds-cto-advisor for")
    lines.append("architecture alignment, and with ds-chro-advisor for comp + leveling.")
    return "\n".join(lines)
