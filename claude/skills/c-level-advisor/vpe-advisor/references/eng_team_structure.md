...
**Operational implication:** team structure is an architecture decision. Coordinate with ds-cto-advisor.
...
- **Hiring criteria for EMs vs senior ICs.** See `ds-chro-advisor`'s leveling references.
- **Comp differences between EM and senior IC tracks.** See `ds-chro-advisor`'s comp benchmarker.
- **Cross-functional roadmap planning.** See `ds-coo-advisor`'s operating cadence.
