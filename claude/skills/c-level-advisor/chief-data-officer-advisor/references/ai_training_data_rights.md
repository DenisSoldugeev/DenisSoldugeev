...
7. **Cross-check with ds-general-counsel-advisor** on top-3 mitigation items.
8. **Cross-check with ds-ciso-advisor** on data flow security.
9. **Log the decision via `/ds:decide`.**
