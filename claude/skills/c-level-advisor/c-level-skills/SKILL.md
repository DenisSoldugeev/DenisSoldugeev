...
```
1. Run /ds:setup → creates company-context.md (all agents read this)
...
3. For big decisions → /ds:board triggers a multi-role board meeting
   ✓ Confirm at least 3 roles have weighed in before accepting a conclusion.
```

### Commands

#### `/ds:setup` — Onboarding Questionnaire
...
### Example: company-context.md (after /ds:setup)
