...
description: "Project management skills: scrum master, senior PM, Atlassian Jira/Confluence/admin."
---

# project-management

Project management skills: scrum master, senior PM, Atlassian Jira/Confluence/admin.

9 skills. Load the specific sub-skill SKILL.md you need on demand.

| Skill | Path | Focus |
|-------|------|-------|
| atlassian-admin | `atlassian-admin/SKILL.md` | Atlassian Administrator for managing and organizing Atlassian products (Jira, Confluence, Bitbucket, Trello), … |
| atlassian-templates | `atlassian-templates/SKILL.md` | Atlassian Template and Files Creator/Modifier expert for creating, modifying, and managing Jira and Confluence… |
