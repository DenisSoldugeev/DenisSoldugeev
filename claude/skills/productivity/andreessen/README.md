...
├── README.md
├── agents/ds-andreessen.md
├── commands/
│   ├── ds-andreessen.md          # /ds:andreessen — full verdict mode
│   └── ds-pmf-check.md           # /ds:pmf-check — focused PMF interrogation
└── skills/andreessen/
    ├── SKILL.md
...
- `/ds:andreessen` — full market-first verdict mode (venture / idea / feature / career bet, or daily card).
- `/ds:pmf-check` — focused before/after product/market fit interrogation.
