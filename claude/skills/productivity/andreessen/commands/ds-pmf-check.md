---
name: "ds-pmf-check"
description: "/ds:pmf-check — Are you before or after product/market fit? A focused Andreessen-mode interrogation that scores the felt signals + the Sean Ellis 40% gate and issues BEFORE-PMF / APPROACHING-PMF / AFTER-PMF with explicit confidence and a single next move."
---

# /ds:pmf-check — Product/Market Fit Interrogation

**Command:** `/ds:pmf-check`

A focused slice of the `ds-andreessen` persona aimed at one question: are you before or after
...
- Agent: [`ds-andreessen`](../agents/ds-andreessen.md)
- Skill: [`andreessen`](../skills/andreessen/SKILL.md)
- Parent command: [`/ds:andreessen`](./ds-andreessen.md)
