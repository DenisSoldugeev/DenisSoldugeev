...
This skill is a Path-B direct conversion of [`megaprompts/05-capture-megaprompt.md`](../../megaprompts/05-capture-megaprompt.md) (PR #657). The megaprompt is the canonical spec; this plugin is the working implementation. Drift between the two is a bug — re-grill with `/ds:grill-with-docs` if they diverge.
...
| `agents/ds-capture.md` | Capture-organizer persona (no-fabrication, voice-preservation enforcer) |
| `commands/ds-capture.md` | `/ds:capture <dump>` slash command for explicit invocation |
