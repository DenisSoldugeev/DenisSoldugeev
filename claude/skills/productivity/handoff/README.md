...
This plugin lives at `productivity/handoff/`. Enable through your plugin manager. On first invocation of `/ds:handoff`, the skill will prompt:
...
Re-configure any time with `/ds:handoff-setup`.

## Slash commands

| Command | Use |
|---|---|
| `/ds:handoff [goal]` | Generate the handoff doc. |
| `/ds:handoff-setup [--project]` | Configure (or reconfigure) save location, retention, redaction. |
