...
goal: "Finish wiring the redaction linter into /ds:handoff and ship a draft PR before EOD."
---
...
Finish wiring the redaction linter into `/ds:handoff` and ship a draft PR before EOD.
...
- In flight:
  - Wiring `ds-handoff.md` command to call linter after template generator — uncommitted in `productivity/handoff/commands/`
- Blocked:
