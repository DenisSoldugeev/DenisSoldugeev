---
name: "productivity"
description: "Personal productivity skills: capture, inbox/email triage, reflection, handoff."
---
...
| Skill | Path | Focus |
|-------|------|-------|
| andreessen | `andreessen/skills/andreessen/SKILL.md` | Marc Andreessen-mode decision and productivity skill. A blunt, market-first operator that pressure-tests ideas… |
| capture | `capture/skills/capture/SKILL.md` | Captures and organizes chaotic brain dumps into a structured, actionable system with zero information loss. Us… |
