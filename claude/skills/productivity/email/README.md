...
```
┌──────────────────────┐         ┌──────────────────────────────┐
│   /ds:inbox-setup    │   ───►  │  ${WORKSPACE}/Email/          │
...
The megaprompts are canonical; these plugins are working implementations. Drift between any megaprompt and its skill is a bug — re-grill with `/ds:grill-with-docs` if they diverge.
...
├── README.md
├── agents/
│   ├── ds-inbox-setup.md           ← interview persona, 8-section grill enforcer
│   └── ds-inbox-triage.md          ← recurring-run persona, DRAFTS-ONLY enforcer
├── commands/
│   ├── ds-inbox-setup.md           ← /ds:inbox-setup
│   └── ds-inbox-triage.md          ← /ds:inbox-triage
└── skills/
    ├── inbox-setup/
...
#    Use /ds:inbox-setup or trigger phrases like "set up my inbox"

# 2. After setup, run inbox-triage on cadence (e.g., 2x/day):
#    Use /ds:inbox-triage or trigger phrases like "triage my inbox"
