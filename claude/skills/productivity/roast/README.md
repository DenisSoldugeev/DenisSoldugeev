...
Or just say **"roast this idea: …"** or run `/ds:roast`.

## What's in the box

- **Skill:** [`skills/roast/SKILL.md`](skills/roast/SKILL.md)
- **Agent:** [`agents/ds-roast-judge.md`](agents/ds-roast-judge.md)
- **Command:** [`commands/ds-roast.md`](commands/ds-roast.md) — `/ds:roast`
...
- **`c-level-advisor` `/ds:boardroom`** — an enterprise C-suite pipeline needing onboarding. Roast is
