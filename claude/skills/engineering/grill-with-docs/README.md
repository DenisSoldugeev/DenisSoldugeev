...
| **ds-grill-with-docs persona agent** | `agents/ds-grill-with-docs.md` | Docs-aware grill voice; pre-flights the linters before the first question |
| **`/ds:grill-with-docs` slash command** | `commands/ds-grill-with-docs.md` | Activation + workflow handoff |
...
# 4. Use /ds:grill-with-docs to start the session
```
