...
The `ds-grill-with-docs` agent orchestrates the `grill-with-docs` skill across docs-anchored grilling sessions:
...
- **vs `ds-grill-master`** (the plan-only grill): different grounding (docs+code vs plan-only)
- **vs `ds-skill-author`** (skill authoring): different mode (interrogate vs build)
- **vs `ds-caveman-mode`** (compression): different concern (depth vs brevity)
...
- [ds-grill-master](../../grill-me/agents/ds-grill-master.md) — plan-only grill (sibling skill, no docs anchor)
- [ds-skill-author](../../write-a-skill/agents/ds-skill-author.md) — different domain (skill authoring)
- [ds-caveman-mode](../../caveman/agents/ds-caveman-mode.md) — different mode (compression)
- [ds-handoff-author](../../handoff/agents/ds-handoff-author.md) — uses grill output for session handoff
...
- Sibling command: [`/ds:grill-with-docs`](../commands/ds-grill-with-docs.md)
