...
| **Persona agent** | `agents/ds-workflow-architect.md` | Design-first interrogator that refuses to write before the topology is confirmed. |
| **Slash command** | `commands/ds-workflow-build.md` | `/ds:workflow-build <task>` — runs the full intake → scaffold → validate flow. |
