---
name: "ds-workflow-build"
description: "/ds:workflow-build <task-description> — Design and write a deterministic Claude Code workflow (.js). Opens with intake questions, infers-and-proposes a topology when the request is vague, then scaffolds + validates the file. Use when building or running a custom Claude Code workflow."
---

# /ds:workflow-build — Workflow Architect Intake

**Command:** `/ds:workflow-build <task-description>`
...
- Agent: [`ds-workflow-architect`](../agents/ds-workflow-architect.md)
- Skill: [`workflow-builder`](../skills/workflow-builder/SKILL.md)
- Adjacent: `/ds:write-a-skill` (authoring skills, not workflows)
