---
name: "ds-write-a-skill"
description: "/ds:write-a-skill <name-or-description> — Author a new agent skill with Matt Pocock's 3-phase workflow (Gather → Draft → Review). Runs 6 review-checklist items + 3 validator tools as a gate. Use when starting a new skill in this repo."
---

# /ds:write-a-skill — Skill-Author Forcing Questions

**Command:** `/ds:write-a-skill <name-or-description>`
...
- `/ds:karpathy-check` — for code-quality concerns in scripts/
- `/ds:tdd` — for testing discipline (different from skill quality gates)
- `/ds:decide` — to log the verdict

## Related

- Agent: [`ds-skill-author`](../agents/ds-skill-author.md)
