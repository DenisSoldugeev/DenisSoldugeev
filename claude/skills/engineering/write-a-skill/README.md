...
| **ds-skill-author persona agent** | `agents/ds-skill-author.md` | Surface skill-authoring as a forcing-question interrogation matching our ds-* persona pattern. |
| **`/ds:write-a-skill` slash command** | `commands/ds-write-a-skill.md` | 6-question forcing interrogation that runs Matt's review checklist programmatically. |
