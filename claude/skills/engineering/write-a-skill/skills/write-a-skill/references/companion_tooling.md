...
Validation tools + ds-* wrapper layered on top of Matt's write-a-skill. Use these when authoring a new skill in this repo.
...
## ds-skill-author Persona Agent

Lives at `../agents/ds-skill-author.md`. Voice: forcing-question interrogator. Surfaces Matt's skill-authoring workflow as an interrogation before any new skill commit.
...
## `/ds:write-a-skill` Slash Command

Lives at `../commands/ds-write-a-skill.md`. Three-step flow:

1. Run `ds-skill-author` interrogation (6 questions)
...
2. **Forcing-question interrogation** (the ds-skill-author persona) — adapts Matt's "review with user" phase to the ds-* persona pattern used elsewhere in this repo.
