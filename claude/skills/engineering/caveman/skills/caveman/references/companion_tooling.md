...
Compression tools + ds-* wrapper layered on top of Matt's caveman skill.
...
## ds-caveman-mode Persona Agent

Lives at `../agents/ds-caveman-mode.md`. Voice: terse, fragments-OK, no filler. Persistence is the hard rule — once activated stays active until "stop caveman" / "normal mode".

## `/ds:caveman` Slash Command

Lives at `../commands/ds-caveman.md`. Single-trigger activation. Equivalent to typing "caveman mode" but more explicit.
