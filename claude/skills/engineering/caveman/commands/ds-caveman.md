---
name: "ds-caveman"
description: "/ds:caveman — Activate persistent caveman-mode. Ultra-compressed responses with technical substance preserved. Auto-clarity exception for warnings + destructive ops. Stays active until 'stop caveman' / 'normal mode'."
---

# /ds:caveman — Caveman Mode
...
- Agent: [`ds-caveman-mode`](../agents/ds-caveman-mode.md)
- Skill: [`caveman`](../skills/caveman/SKILL.md)
- Adjacent: `/ds:grill-me`, `/ds:handoff` (other Pocock-derived skills)
