...
- **vs `ds-skill-author`** (forcing questions): different mode entirely.
...
User types "caveman mode" / "talk like caveman" / `/ds:caveman` →
...
- [ds-skill-author](../../write-a-skill/agents/ds-skill-author.md) — meta-skill for skill authoring (NOT caveman)
- [ds-grill-master](../../grill-me/agents/ds-grill-master.md) — forcing-questions mode (also terse, different purpose)
...
- Sibling command: [`/ds:caveman`](../commands/ds-caveman.md)
