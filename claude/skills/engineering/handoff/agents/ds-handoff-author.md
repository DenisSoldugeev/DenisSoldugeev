...
The ds-handoff-author agent orchestrates the `handoff` skill across session-continuity tasks:
...
- **vs ds-grill-master** (plan interrogation): different mode (continuity vs interrogation)
- **vs ds-skill-author** (skill authoring): different domain (handoff content vs skill files)
- **vs `/ds:decide`** (decision logging): different artifact (handoff is forward-looking; decide is backward-looking)
...
- [ds-skill-author](../../write-a-skill/agents/ds-skill-author.md) — skill authoring (consumes handoffs that mention "new skill")
- [ds-grill-master](../../grill-me/agents/ds-grill-master.md) — plan interrogation (different mode)
- [ds-caveman-mode](../../caveman/agents/ds-caveman-mode.md) — compression (handoffs are usually NOT caveman — full prose for next-agent clarity)
...
- Sibling command: [`/ds:handoff`](../commands/ds-handoff.md)
