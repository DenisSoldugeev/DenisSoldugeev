...
| **ds-handoff-author persona agent** | `agents/ds-handoff-author.md` | Continuity-focused handoff author with hard rule against duplication |
| **`/ds:handoff` slash command** | `commands/ds-handoff.md` | One-shot handoff generation with argument hint |
