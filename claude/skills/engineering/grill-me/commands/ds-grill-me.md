---
name: "ds-grill-me"
description: "/ds:grill-me <path-to-plan> — Start a relentless interrogation of a plan or design. Walks decision tree one branch at a time. One question per turn with recommended answer. Explores codebase before asking."
---

# /ds:grill-me — Relentless Plan Interrogation

**Command:** `/ds:grill-me <path-to-plan>`
...
- Agent: [`ds-grill-master`](../agents/ds-grill-master.md)
