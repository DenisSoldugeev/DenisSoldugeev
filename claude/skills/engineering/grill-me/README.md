...
| **ds-grill-master persona agent** | `agents/ds-grill-master.md` | One-question-at-a-time enforcer with state tracking |
| **`/ds:grill-me` slash command** | `commands/ds-grill-me.md` | Activation + session start |
