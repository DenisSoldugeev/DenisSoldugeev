...
The ds-grill-master agent orchestrates the `grill-me` skill across plan-interrogation sessions:
...
- **vs ds-skill-author** (skill authoring): different mode (build vs interrogate)
- **vs ds-caveman-mode** (compression): different concern (depth vs brevity)
- **vs `/ds:cto-review`** (executive review): tactical vs strategic, narrower scope
...
- Sibling command: [`/ds:grill-me`](../commands/ds-grill-me.md)
