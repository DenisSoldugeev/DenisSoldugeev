...
Interrogation tools + ds-* wrapper layered on top of Matt's grill-me skill.
...
## ds-grill-master Persona Agent

Lives at `../agents/ds-grill-master.md`. Voice: relentless, one-question-at-a-time, codebase-exploration-first.
...
## `/ds:grill-me` Slash Command

Lives at `../commands/ds-grill-me.md`. Activation pattern:

1. `/ds:grill-me <path-to-plan>` — start grill session on plan doc
