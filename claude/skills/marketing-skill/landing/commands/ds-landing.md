---
name: "ds-landing"
description: "/ds:landing <product-or-brief> — Generate a premium single-file HTML landing page with GSAP 3D animations, scroll-triggered reveals, and mouse-parallax depth. Grill-me intake (4 questions) locks down product / audience / brand / tone before any markup. Output: ${OUTPUT_DIR}/<product-kebab>.html or HTML artifact."
---

# /ds:landing — Premium HTML Landing Page Generator

**Command:** `/ds:landing <product-or-brief>`

The `ds-landing` persona generates one polished, self-contained `.html` landing page with GSAP animations, mouse parallax, and 3D CSS effects.
...
| Need | Skill |
|---|---|
| Visual premium one-pager | **`/ds:landing`** (this command) |
...
- Agent: [`ds-landing`](../agents/ds-landing.md)
...
- Adjacent v2 commands: `/ds:capture`, `/ds:pulse`, `/ds:inbox-setup`, `/ds:inbox-triage`
