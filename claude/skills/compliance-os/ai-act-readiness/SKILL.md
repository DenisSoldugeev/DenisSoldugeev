...
description: "/ds:ai-act-readiness <system> — EU AI Act 6-question forcing interrogation. Use during AI-system intake, before EU deployment, or during annual compliance refresh as Article 113 obligations phase in (2025-02-02 / 2025-08-02 / 2026-08-02 / 2027-08-02)."
---

# /ds:ai-act-readiness — EU AI Act Forcing Questions

**Command:** `/ds:ai-act-readiness <system>`
...
- `/ds:compliance-readiness` — for multi-framework view (combine with ISO 42001 + GDPR)
- `/ds:aims-audit` — for ISO 42001 deep-dive
- `/ds:caio-review` — for executive AI strategy decisions
- `/ds:gc-review` — for novel-case legal review (GPAI threshold, Article 5 boundary, substantial-modification)
- `/ds:decide` — to log the verdict
- `/ds:freeze 30` — on EU launch commitments (regulatory exposure)
