---
name: "aims-audit"
description: "/ds:aims-audit <scope> — ISO/IEC 42001 AIMS internal-audit 6-question forcing interrogation. Use before certification stage 1, before annual internal audit cycles, or when onboarding a new AI system into an existing AIMS."
---

# /ds:aims-audit — AIMS ISO 42001 Forcing Questions

**Command:** `/ds:aims-audit <scope>`
...
- Cross-check with ds-quality-regulatory if integrated with 13485 audit programme
...
- Cross-check with ds-ciso-advisor on ISO 27001 alignment
...
- `/ds:ai-act-readiness` — if EU AI Act also applies
- `/ds:caio-review` — for executive AI strategy decisions
- `/ds:ciso-review` — for ISO 27001 cross-framework alignment
- `/ds:decide` — to log the verdict
- `/ds:freeze 30` — on certification commitments

## Related

- Agent: [`ds-aims-iso42001`](../../agents/ds-aims-iso42001.md)
- Skill: [`iso42001-specialist`](../../ra-qm-team/compliance-team-iso42001/skills/iso42001-specialist/SKILL.md)
