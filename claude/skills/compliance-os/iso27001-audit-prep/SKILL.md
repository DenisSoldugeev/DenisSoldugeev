...
description: "/ds:iso27001-audit-prep <scope> — ISO 27001 ISMS audit readiness 6-question forcing interrogation. Use before annual Clause 9.2 internal audit, surveillance audit prep, or stage 1 certification readiness."
---

# /ds:iso27001-audit-prep — ISO 27001 ISMS Audit Forcing Questions

**Command:** `/ds:iso27001-audit-prep <scope>`
...
- DPAs signed for personal-data sub-processors (cross-check with ds-dpo-gdpr)
- AI-specific contract clauses where third-party AI services in use (cross-check with ds-aims-iso42001)
...
- GDPR Article 33 / 34 notification timing aligned with A.5.24 (cross-check with ds-dpo-gdpr)
...
- `/ds:soc2-audit-prep` — for SOC 2 cross-walk pair (75% overlap)
- `/ds:aims-audit` — for ISO 42001 AIMS cross-walk
- `/ds:gdpr-audit-prep` — for Article 32 organizational measures overlap
- `/ds:ciso-review` — for executive cybersecurity strategy
