...
description: "/ds:gdpr-audit-prep <scope> — GDPR audit 6-question Article-cited forcing interrogation. Use before annual internal GDPR review, post-breach internal audit, DPA investigation readiness, or acquisition due diligence."
---

# /ds:gdpr-audit-prep — GDPR DPO Forcing Questions

**Command:** `/ds:gdpr-audit-prep <scope>`
...
- For AI systems: integrates with EU AI Act Article 27 FRIA (cross-check with ds-ai-act-compliance)
...
- Cross-check with ds-ciso-iso27001 for A.5.24-27 incident management alignment
...
- `/ds:iso27001-audit-prep` — for Article 32 organizational measures
- `/ds:ai-act-readiness` — for EU AI Act Article 27 FRIA integration
- `/ds:soc2-audit-prep` — for SOC 2 Privacy TSC overlap
- `/ds:gc-review` — for novel-case legal review
