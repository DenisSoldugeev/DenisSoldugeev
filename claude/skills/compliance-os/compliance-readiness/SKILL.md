...
description: "/ds:compliance-readiness <program> — Multi-framework compliance officer 6-question forcing interrogation of any compliance program. Use before starting a new framework, planning the annual audit calendar, or preparing for certification stage 1."
---

# /ds:compliance-readiness — Compliance Officer Forcing Questions

**Command:** `/ds:compliance-readiness <program>`
...
- `/ds:aims-audit` — for ISO 42001-specific forcing questions
- `/ds:ai-act-readiness` — for EU AI Act-specific forcing questions
- `/ds:ciso-review` — for cybersecurity strategy
- `/ds:caio-review` — for executive AI strategy
- `/ds:gc-review` — for novel-case legal review
- `/ds:decide` — to log the verdict
- `/ds:freeze 30` — on certification commitments (multi-year financial impact)
