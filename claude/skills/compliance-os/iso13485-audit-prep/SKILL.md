...
description: "/ds:iso13485-audit-prep <scope> — ISO 13485 QMS audit 6-question forcing interrogation. Design controls + CAPA + post-market focused. Use before Clause 8.2.4 internal audit, MDR / FDA QSR alignment review, or product-launch DHF closure audit."
---

# /ds:iso13485-audit-prep — ISO 13485 QMS Forcing Questions

**Command:** `/ds:iso13485-audit-prep <scope>`
...
- Cross-check with ds-fda-qsr-auditor for 21 CFR 820.75 alignment
...
- MDR reports per 21 CFR 803 for US-marketed devices (cross-check with ds-fda-qsr-auditor)
...
- FDA QSR alignment (post-Feb 2026): substantially harmonized; FDA-specific overlays per ds-fda-qsr-auditor
...
- `/ds:compliance-readiness` — for multi-framework view
- `/ds:fda-qsr-audit-prep` — for FDA-specific overlay
- `/ds:aims-audit` — for AI-enabled medical device ISO 42001 layer
- `/ds:gdpr-audit-prep` — for personal-data overlap (clinical data, customer data)
- `/ds:cpo-review` — for executive product strategy decisions
- `/ds:decide` — to log the verdict
