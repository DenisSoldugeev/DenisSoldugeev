...
description: "/ds:soc2-audit-prep <scope> — SOC 2 Type II readiness 6-question forcing interrogation. Observation-period focused. Use before Type II observation begins, mid-period checkpoint, or pre-field-test month-10 readiness."
---

# /ds:soc2-audit-prep — SOC 2 Type II Forcing Questions

**Command:** `/ds:soc2-audit-prep <scope>`
...
- Coordinate audit calendar with ds-ciso-iso27001
...
- `/ds:iso27001-audit-prep` — for ISO 27001 cross-walk pair (75% overlap)
- `/ds:gdpr-audit-prep` — for Privacy TSC overlap
