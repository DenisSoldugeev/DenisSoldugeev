...
The ds-notebooklm agent orchestrates the `notebooklm` skill across NotebookLM browser-automation workflows:
...
- [ds-pulse](../../pulse/agents/ds-pulse.md) — research domain, different shape (multi-source web)
- [ds-litreview](../../litreview/agents/ds-litreview.md) — research domain, Consensus-based
- Future: ds-research orchestrator (Slice 7)
