---
name: "ds-notebooklm"
description: "/ds:notebooklm — NotebookLM browser automation. Action-routing intake (Q1: read / add source / Studio output / create new) + per-action Q2-Q4 branching. Fire-and-notify for slow Studio ops. Mandatory custom prompts (defaults are mediocre). Requires browser automation environment — fails clean on web."
---

# /ds:notebooklm — NotebookLM Browser Automation

**Command:** `/ds:notebooklm`

The `ds-notebooklm` persona controls Google NotebookLM via browser automation across 4 core actions.
...
- Agent: [`ds-notebooklm`](../agents/ds-notebooklm.md)
...
- Research-domain siblings (different shape): `/ds:pulse`, `/ds:litreview`, `/ds:grants`, `/ds:dossier`, `/ds:patent`, `/ds:syllabus`
