...
The `ds-deep-research` agent orchestrates the `deep-research` skill to turn "research this" into an auditable, reusable investigation:
...
- [ds-pulse](../../pulse/agents/ds-pulse.md) — recency/sentiment research sibling
- [ds-research](../../research/agents/ds-research.md) — the fast router/orchestrator
