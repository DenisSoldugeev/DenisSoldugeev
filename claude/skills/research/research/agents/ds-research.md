...
The ds-research agent orchestrates the `research` skill as the **runtime orchestrator** for the research domain:
...
- All 6 routing targets (research/): ds-pulse, ds-litreview, ds-grants, ds-dossier, ds-patent, ds-syllabus
- [ds-notebooklm](../../notebooklm/agents/ds-notebooklm.md) — research-domain sibling, browser-automation shape (NOT a routing target — different mode)
