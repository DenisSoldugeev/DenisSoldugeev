...
The ds-dossier agent orchestrates the `dossier` skill across hypothesis-tested entity research:
...
- [ds-litreview](../../litreview/agents/ds-litreview.md) — sibling, academic literature
- [ds-grants](../../grants/agents/ds-grants.md) — sibling, NIH funding
- [ds-pulse](../../../research/pulse/agents/ds-pulse.md) — sibling, multi-platform recency
- Future: ds-patent (patent prior-art), ds-syllabus (course readings)
