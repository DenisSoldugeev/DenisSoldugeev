---
name: "ds-syllabus"
description: "/ds:syllabus <syllabus-file-or-paste> — Generate curated supplementary reading list from any course syllabus. 3-Q grill-me (input format + audience + year range) + grouping checkpoint → Consensus searches per section with applied-domain weaving → .docx via bundled JS script with audience-calibrated summaries + Bloom higher-order discussion questions."
---

# /ds:syllabus — Course Supplementary Reading List

**Command:** `/ds:syllabus <syllabus-file-or-paste>`

The `ds-syllabus` persona produces a `.docx` reading list of recent peer-reviewed research per course section.
...
- Agent: [`ds-syllabus`](../agents/ds-syllabus.md)
...
- Siblings: `/ds:litreview`, `/ds:grants`, `/ds:patent`, `/ds:dossier`, `/ds:pulse`
