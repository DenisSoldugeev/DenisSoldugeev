...
The ds-syllabus agent orchestrates the `syllabus` skill across course-reading-list generation:
...
- [ds-patent](../../patent/agents/ds-patent.md) — sibling, patent prior-art
- [ds-dossier](../../dossier/agents/ds-dossier.md) — sibling, entity research
