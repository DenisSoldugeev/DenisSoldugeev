...
The ds-litreview agent orchestrates the `litreview` skill across academic-research-orientation sessions:
...
- **vs ds-pulse**: Different source (PubMed/OpenAlex + optional Consensus vs Reddit/HN/Web), different output (DOCX vs multi-platform briefing), different execution (sequential vs parallel-across-sources)
- **vs ds-grants** (future): Different domain (any research field vs NIH-specific funding)
- **vs ds-syllabus** (future): Different intent (orient researcher vs supplement course)
...
- [ds-pulse](../../../research/pulse/agents/ds-pulse.md) — research-pack sibling
- [ds-grill-master](../../../engineering/grill-me/agents/ds-grill-master.md) — plan-only grill (different domain)
- Future research-pack siblings: ds-grants, ds-patent, ds-dossier, ds-syllabus
...
- Sibling command: [`/ds:litreview`](../commands/ds-litreview.md)
