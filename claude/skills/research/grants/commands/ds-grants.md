---
name: "ds-grants"
description: "/ds:grants <research-idea> — NIH funding intelligence. 6-Q grill-me intake (idea + career stage + prelim + environment + posture + institutes) → 5-facet Consensus positioning + RePORTER POST institute mapping + NOSI fetches → 9-section .docx with mandatory program officer recommendation."
---

# /ds:grants — NIH Funding Intelligence

**Command:** `/ds:grants <research-idea>`

The `ds-grants` persona produces a strategic NIH funding overview as an editable `.docx` for clinical researchers.
