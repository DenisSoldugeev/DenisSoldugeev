...
The ds-grants agent orchestrates the `grants` skill:
...
- [ds-litreview](../../litreview/agents/ds-litreview.md) — sibling, academic literature (no RePORTER)
- [ds-pulse](../../../research/pulse/agents/ds-pulse.md) — sibling, multi-platform recency
- Future: ds-patent, ds-dossier, ds-syllabus
