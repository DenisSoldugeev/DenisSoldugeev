...
The ds-patent agent orchestrates the `patent` skill across prior-art + landscape research:
...
- [ds-dossier](../../dossier/agents/ds-dossier.md) — sibling, hypothesis-tested entity research
- Future: ds-syllabus (course readings)
