...
Search `agents/` for any ds-* agent that references this skill:
```bash
...
|--------|-------|-------------|
| `engineering/` or `engineering-team/` | ds-senior-engineer | Architecture, code quality, CI/CD integration |
| `product-team/` | ds-product-manager | PRD quality, user story coverage, RICE alignment |
| `marketing-skill/` | ds-content-creator | Content quality, SEO optimization, brand voice |
| `ra-qm-team/` | ds-quality-regulatory | Compliance checklist, audit trail, regulatory alignment |
| `business-growth/` | ds-growth-strategist | Growth metrics, revenue impact, customer success |
| `finance/` | ds-financial-analyst | Financial model accuracy, metric definitions |
| Other | ds-senior-engineer | General code and architecture review |
