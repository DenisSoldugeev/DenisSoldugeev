...
# /ds:engineer-grill — Cross-role engineering forcing-question grill
...
- `/ds:fullstack-review`, `/ds:frontend-review`, `/ds:backend-review` — single-lane deep dives
- `/karpathy-check` — Karpathy review before commit
- `/ds:grill-bizops`, `/ds:grill-commercial` — sibling cross-domain grills (BizOps + Commercial v2.8.0)
