...
- Full product launch (not just a webinar) → use `/ds:launch` / launch-strategy
...
```bash
/ds:webinar rescue --input funnel.json
```
...
```bash
/ds:webinar score --input funnel.json
/ds:webinar score                 # embedded sample data
```
