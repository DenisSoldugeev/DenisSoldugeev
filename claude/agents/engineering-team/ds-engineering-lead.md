...
- [ds-senior-engineer](../engineering/ds-senior-engineer.md) -- Architecture decisions, code review, and CI/CD pipeline setup
- [ds-product-manager](../product/ds-product-manager.md) -- Feature prioritization and requirements alignment
