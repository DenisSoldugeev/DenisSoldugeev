...
- [ds-product-manager](ds-product-manager.md) - Prioritization and PRDs; hands measurement questions to this agent
- [ds-ux-researcher](ds-ux-researcher.md) - Qualitative evidence to explain the "why" behind metric movements
