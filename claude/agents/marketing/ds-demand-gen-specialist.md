...
- **vs [ds-content-creator](ds-content-creator.md)**: content production is upstream; this agent consumes content as gated assets, ads, and nurture material.
...
- Content for gated assets and nurture bodies → [ds-content-creator](ds-content-creator.md).
- Webinar-driven demand gen → [ds-webinar-marketer](ds-webinar-marketer.md).
...
- [ds-content-creator](ds-content-creator.md) — produces the content this funnel distributes
- [ds-webinar-marketer](ds-webinar-marketer.md) — webinar funnel math and rescue plans
- [ds-aeo](ds-aeo.md) — AI-search citation for organic demand capture
