...
The ds-aeo agent orchestrates the `aeo` skill as the **AEO specialist** for the marketing domain:
...
- **vs `marketing-skill/skills/content-strategy`**: content-strategy plans WHAT to write; ds-aeo optimizes WHAT'S BEEN WRITTEN for AI citation.
- **vs `marketing-skill/skills/schema-markup`**: schema-markup implements; ds-aeo prescribes which schema to add based on content type.
...
- [ds-content-creator](ds-content-creator.md) — marketing-domain content writer
- [seo-audit](../../skills/marketing-skill/seo-audit/SKILL.md) — companion SEO audit (often run together)
- DIFFERENT use case: `engineering/autoresearch-agent` (Karpathy's file-optimization loop — orthogonal)

---

**Version:** 2.7.3
**Source:** Ported from `/aeo-box` `answer-engine-optimization/` skill
**License:** MIT
