---
name: developer-lead
description: Engineering Team Lead. Spawn when the task requires coordinating multiple teams or domains simultaneously incident response across services, cross-team feature delivery with shared API contracts, tech stack evaluation impacting 2+ teams, or team health audits. Do NOT spawn for single-component technical work — use developer-senior instead.
...
### Development
- `engineering-team/senior-frontend` — React design systems
...
- [developer-senior](../engineering/developer-senior.md) - Architecture decisions, code review, and CI/CD pipeline setup
