...
- [ds-engineering-lead](../engineering-team/ds-engineering-lead.md) -- Team coordination, incident response, and cross-functional delivery
- [ds-product-manager](../product/ds-product-manager.md) -- Feature prioritization and requirements context
