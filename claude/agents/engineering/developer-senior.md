...
description: Senior Engineer. Spawn when the task is a single technical problem within one domain system architecture design, code review of a specific PR, CI/CD pipeline setup, database schema design, debugging a specific feature, or technical debt assessment. Do NOT spawn for multi-team coordination or incident management — use developer-lead instead.
skills: engineering
model: sonnet
...
- [developer-lead](../developer-team/developer-lead.md) -- Team coordination, incident response, and cross-functional delivery
